(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('d3-shape'), require('recompose/compose'), require('recompose/pure'), require('recompose/withPropsOnChange'), require('recompose/defaultProps'), require('@nivo/core'), require('@nivo/axes'), require('@nivo/scales'), require('@nivo/legends'), require('prop-types'), require('lodash/isFunction'), require('d3-format'), require('recompose/withState'), require('recompose/withHandlers'), require('react-motion')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'd3-shape', 'recompose/compose', 'recompose/pure', 'recompose/withPropsOnChange', 'recompose/defaultProps', '@nivo/core', '@nivo/axes', '@nivo/scales', '@nivo/legends', 'prop-types', 'lodash/isFunction', 'd3-format', 'recompose/withState', 'recompose/withHandlers', 'react-motion'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.d3, global.RecomposeCompose, global.RecomposePure, global.RecomposeWithPropsOnChange, global.RecomposeDefaultProps, global.nivo, global.nivo, global.nivo, global.nivo, global.PropTypes, global['lodash/isFunction'], global.d3, global.RecomposeWithState, global.RecomposeWithHandlers, global.ReactMotion));
}(this, function (exports, React, d3Shape, compose, pure, withPropsOnChange, defaultProps, core, axes, scales, legends, PropTypes, isFunction, d3Format, withState, withHandlers, reactMotion) { 'use strict';
    ...
    var LineLines = function LineLines(_ref) {
      var lines = _ref.lines,
          ...
          motionStiffness = _ref.motionStiffness,
          motionDamping = _ref.motionDamping;
      return React__default.createElement("g", null, lines.map(function (_ref2) {
        var id = _ref2.id,
            data = _ref2.data,
            color = _ref2.color;
    ...
    var Line$1 = function Line(props) {
      ...
      return React__default.createElement(core.Container, {
        ...
        var showTooltip = _ref.showTooltip,
            hideTooltip = _ref.hideTooltip;
        var layerById = {
          grid: React__default.createElement(core.Grid, _extends$1({
            key: "grid",
            theme: theme,
            width: width,
            height: height,
          ...
          areas: null,
          lines: React__default.createElement(LineLines$1, _extends$1({
            key: "lines",
        ...
        if (enableArea) {
          layerById.areas = React__default.createElement(LineAreas$1, _extends$1({
            key: "areas",
        ...
        if (enableDots) {
          layerById.dots = React__default.createElement(LineDots, _extends$1({
            key: "dots",
            lines: computedData.series,
            symbol: dotSymbol,
            size: dotSize,
    ...
    var ResponsiveLine = function ResponsiveLine(props) {
      return React__default.createElement(core.ResponsiveWrapper, null, function (_ref) {
        var width = _ref.width,
            height = _ref.height;
        return React__default.createElement(enhancedLine, _extends$2({
          width: width,
          height: height
        }, props));
      });
