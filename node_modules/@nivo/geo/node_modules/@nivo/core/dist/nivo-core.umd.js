(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash/merge'), require('lodash/get'), require('lodash/set'), require('lodash/isFunction'), require('d3-format'), require('react-measure'), require('recompose/pure'), require('react-motion'), require('d3-interpolate'), require('d3-time-format'), require('recompose/compose'), require('recompose/withPropsOnChange'), require('recompose/setPropTypes'), require('recompose/defaultProps'), require('lodash/last'), require('lodash/isArray'), require('lodash/isString'), require('d3-scale'), require('d3-scale-chromatic'), require('lodash/memoize'), require('d3-color'), require('recompose/withProps'), require('lodash/without'), require('d3-shape'), require('d3-hierarchy'), require('lodash/isEqual'), require('lodash/partialRight'), require('lodash/isNumber'), require('recompose/shouldUpdate'), require('lodash/isPlainObject'), require('lodash/pick')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash/merge', 'lodash/get', 'lodash/set', 'lodash/isFunction', 'd3-format', 'react-measure', 'recompose/pure', 'react-motion', 'd3-interpolate', 'd3-time-format', 'recompose/compose', 'recompose/withPropsOnChange', 'recompose/setPropTypes', 'recompose/defaultProps', 'lodash/last', 'lodash/isArray', 'lodash/isString', 'd3-scale', 'd3-scale-chromatic', 'lodash/memoize', 'd3-color', 'recompose/withProps', 'lodash/without', 'd3-shape', 'd3-hierarchy', 'lodash/isEqual', 'lodash/partialRight', 'lodash/isNumber', 'recompose/shouldUpdate', 'lodash/isPlainObject', 'lodash/pick'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global['lodash/merge'], global['lodash/get'], global['lodash/set'], global['lodash/isFunction'], global.d3, global['react-measure'], global.RecomposePure, global.ReactMotion, global.d3, global.d3, global.RecomposeCompose, global.RecomposeWithPropsOnChange, global.RecomposeSetPropTypes, global.RecomposeDefaultProps, global['lodash/last'], global['lodash/isArray'], global['lodash/isString'], global.d3, global.d3, global['lodash/memoize'], global.d3, global.RecomposeWithProps, global['lodash/without'], global.d3, global.d3, global['lodash/isEqual'], global['lodash/partialRight'], global['lodash/isNumber'], global.RecomposeShouldUpdate, global['lodash/isPlainObject'], global['lodash/pick']));
}(this, function (exports, React, PropTypes, merge, get, set, isFunction, d3Format, Measure, pure, reactMotion, d3Interpolate, d3TimeFormat, compose, withPropsOnChange, setPropTypes, defaultProps, last, isArray, isString, d3Scale, d3ScaleChromatic, memoize, d3Color, withProps, without, d3Shape, d3Hierarchy, isEqual, partialRight, isNumber, shouldUpdate, isPlainObject, pick) { 'use strict';
