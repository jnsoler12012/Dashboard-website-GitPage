(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('@nivo/core'), require('prop-types'), require('lodash/get'), require('lodash/isFunction'), require('d3-format'), require('d3-geo')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', '@nivo/core', 'prop-types', 'lodash/get', 'lodash/isFunction', 'd3-format', 'd3-geo'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.nivo, global.PropTypes, global['lodash/get'], global['lodash/isFunction'], global.d3, global.d3));
}(this, function (exports, React, core, PropTypes, _get, _isFunction, d3Format, d3Geo) { 'use strict';
    ...
    var useGeoMap = function useGeoMap(_ref) {
      ...
      var getBorderColor = React.useMemo(function () {
        return typeof borderColor === 'function' ? borderColor : function () {
          return borderColor;
        };
      }, [borderColor]);
    ...
    var useChoropleth = function useChoropleth(_ref2) {
      ...
      var getFillColor = React.useMemo(function () {
        var colorScale = core.guessQuantizeColorScale(colors).domain([0, 1000000]);
    ...
    var GeoMap = React.memo(function (props) {
      ...
      var handleMouseEnter = React.useCallback(function (feature, event) {
        return isInteractive && Tooltip && showTooltip(React__default.createElement(Tooltip, {
          feature: feature
        }), event);
    ...
    var GeoMapCanvas = function GeoMapCanvas(props) {
      var width = props.width,
          height = props.height,
          partialMargin = props.margin,
      ...
      }, [canvasEl, outerWidth, outerHeight, margin, pixelRatio, theme, path, graticule, getFillColor, getBorderWidth, getBorderColor]);
      var _useTooltip = core.useTooltip(),
    ...
    var Choropleth = function Choropleth(props) {
      var _useChoropleth = useChoropleth(props),
          getFillColor = _useChoropleth.getFillColor,
          boundFeatures = _useChoropleth.boundFeatures;
      return React__default.createElement(GeoMap$1, _extends$2({}, props, {
    ...
    var ResponsiveChoropleth = function ResponsiveChoropleth(props) {
      return React__default.createElement(core.ResponsiveWrapper, null, function (_ref) {
        var width = _ref.width,
            height = _ref.height;
        return React__default.createElement(Choropleth, _extends$3({
          width: width,
          height: height
        }, props));
      });
    ...
    var ChoroplethCanvas = function ChoroplethCanvas(props) {
      var _useChoropleth = useChoropleth(props),
          getFillColor = _useChoropleth.getFillColor,
          boundFeatures = _useChoropleth.boundFeatures;
      return React__default.createElement(GeoMapCanvas$1, _extends$4({}, props, {
        features: boundFeatures,
        fillColor: getFillColor
      }));
    };
    ...
    var ResponsiveChoroplethCanvas = function ResponsiveChoroplethCanvas(props) {
      return React__default.createElement(core.ResponsiveWrapper, null, function (_ref) {
        var width = _ref.width,
            height = _ref.height;
        return React__default.createElement(ChoroplethCanvas, _extends$5({
          width: width,
          height: height
        }, props));
      });
    ...
    exports.ChoroplethCanvas = ChoroplethCanvas;
