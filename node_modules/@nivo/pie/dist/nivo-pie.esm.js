...
import { withColors, computeArcBoundingBox, degreesToRadians, radiansToDegrees, noop, BasicTooltip, absoluteAngleRadians, midAngle, positionFromAngle, absoluteAngleDegrees, textPropsByEngine, axisThemePropType, labelsThemePropType, themePropType, withTheme, withDimensions, getLabelGenerator, getInheritedColorGenerator, bindDefs, Container, SvgWrapper, ResponsiveWrapper, getRelativeCursor, getHoveredArc } from '@nivo/core';
...
var enhance = function enhance(Component) {
  return compose(defaultProps(PieLayoutDefaultProps), withColors(), withPropsOnChange(['width', 'height', 'innerRadius', 'startAngle', 'endAngle', 'fit', 'cornerRadius'], function (_ref) {
      ...
      return React.createElement(PieLayout$1, {
        ...
        return React.createElement(Container, {
          ...
          return React.createElement(SvgWrapper, {
            ...
            textColor: getInheritedColorGenerator(radialLabelsTextColor, 'labels.text.fill'),
            linkColor: getInheritedColorGenerator(radialLabelsLinkColor, 'axis.ticks.line.stroke'),
            theme: theme
...
function (_Component) {
  ...
  _createClass$5(PieCanvasRenderer, [{
    ...
    value: function draw(props) {
      ...
      var getBorderColor = getInheritedColorGenerator(borderColor);
      ...
      if (enableRadialLabels === true) {
        ...
        drawRadialLabels(this.ctx, arcs, {
          ...
          getLinkColor: getInheritedColorGenerator(radialLabelsLinkColor, 'axis.ticks.line.stroke'),
          theme: theme
        });
      }
      this.ctx.restore();
...
export { Pie$1 as Pie, PieCanvas$1 as PieCanvas, PieDefaultProps, PieLayout$1 as PieLayout, PiePropTypes, ResponsivePie, ResponsivePieCanvas, arcPropType };
