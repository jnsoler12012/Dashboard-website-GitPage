(function (global, factory) {
    typeof exports === 'object' && typeof module !== 'undefined' ? factory(exports, require('react'), require('prop-types'), require('lodash/isFunction'), require('lodash/isNumber'), require('lodash/isPlainObject')) :
    typeof define === 'function' && define.amd ? define(['exports', 'react', 'prop-types', 'lodash/isFunction', 'lodash/isNumber', 'lodash/isPlainObject'], factory) :
    (global = global || self, factory(global.nivo = global.nivo || {}, global.React, global.PropTypes, global['lodash/isFunction'], global['lodash/isNumber'], global['lodash/isPlainObject']));
}(this, function (exports, React, PropTypes, isFunction, isNumber, isPlainObject) { 'use strict';
    ...
    var LegendSvgItem =
    function (_Component) {
      _inherits$4(LegendSvgItem, _Component);
      function LegendSvgItem() {
        var _getPrototypeOf2;
        var _this;
        _classCallCheck$4(this, LegendSvgItem);
        for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
          args[_key] = arguments[_key];
        }
        _this = _possibleConstructorReturn$4(this, (_getPrototypeOf2 = _getPrototypeOf$4(LegendSvgItem)).call.apply(_getPrototypeOf2, [this].concat(args)));
        _defineProperty$6(_assertThisInitialized$4(_this), "state", {
          style: {}
        });
        _defineProperty$6(_assertThisInitialized$4(_this), "handleClick", function (event) {
        ...
        _defineProperty$6(_assertThisInitialized$4(_this), "handleMouseEnter", function (event) {
        ...
        _defineProperty$6(_assertThisInitialized$4(_this), "handleMouseLeave", function () {
      ...
      _createClass$4(LegendSvgItem, [{
        ...
        value: function render() {
          var _this$props4 = this.props,
              ...
              justify = _this$props4.justify,
              textColor = _this$props4.textColor,
              background = _this$props4.background,
              opacity = _this$props4.opacity,
              symbolShape = _this$props4.symbolShape,
              symbolSize = _this$props4.symbolSize,
              symbolSpacing = _this$props4.symbolSpacing,
              symbolBorderWidth = _this$props4.symbolBorderWidth,
              symbolBorderColor = _this$props4.symbolBorderColor,
    ...
    _defineProperty$6(LegendSvgItem, "propTypes", _objectSpread$6({
    ...
    _defineProperty$6(LegendSvgItem, "defaultProps", {
